            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div class="btn-group">
                            <button @click="getAppointments()" type="button" class="btn" :class="[typeof selectStatus === 'undefined' ? 'btn-secondary': 'btn-default']">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr v-for="(appointment, index) in appointments.data" :key="appointment.id">
                                        <td>{{ index + 1 }}</td>
                                        <td>{{ appointment.client.firts_name }} {{ appointment.client.last_name }}</td>
